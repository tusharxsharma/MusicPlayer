...
leftframe = Frame(root,background="pink")
...
rightframe = Frame(root,background="pink")
rightframe.pack(pady=30)

topframe = Frame(rightframe,background="pink")
topframe.pack()
...
middleframe = Frame(rightframe,background="pink")
middleframe.pack(pady=30, padx=30)



playPhoto = PhotoImage(file='images/play (1).png')
...
bottomframe = Frame(rightframe,background="pink")
bottomframe.pack()
